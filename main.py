...
def main():
    ...
    bmqy_feed =  get_link_info("https://www.bmqy.net/feed", 3)
    print(bmqy_feed)
    ...
    fmt = '%Y-%m-%d %H:%M:%S %Z%z'
    insert_info = "<!--START_SECTION:bmqy-->\n\n## bmqy.net的每日更新(" + "更新时间:"+  datetime.fromtimestamp(int(time.time()),pytz.timezone('Asia/Shanghai')).strftime('%Y-%m-%d %H:%M:%S') + " | 本部分通过Github Actions抓取RSS自动更新...)" +"\n" + insert_info + "\n<!--END_SECTION:bmqy-->"
    # 获取README.md内容
